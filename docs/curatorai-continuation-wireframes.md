...
### Typography Scale
```
H1: 48px/56px - Bold - #111111 - Hero Headlines
H2: 36px/44px - Bold - #111111 - Page Titles
H3: 30px/36px - SemiBold - #111111 - Section Headers
H4: 24px/32px - SemiBold - #111111 - Card Titles
H5: 20px/28px - Medium - #111111 - Subsections
H6: 18px/24px - Medium - #7A7A7A - Small Headers

Body Large:  18px/28px - Regular - #7A7A7A
Body:        16px/24px - Regular - #7A7A7A
Body Small:  14px/20px - Regular - #7A7A7A
Caption:     12px/16px - Regular - #9CA3AF
Overline:    12px/16px - Bold - #7A7A7A - Uppercase
```
...
├──────────────────────────────────────────────────────────┤
│ Default    │ #FFFFFF    │ #E5E7EB   │ #111111  │ #7A7A7A│
│ Hover      │ #F8F8F8    │ #D72638   │ #111111  │ #D72638│
│ Active     │ #EEF2FF    │ #D72638   │ #4F46E5  │ #4F46E5│
│ Focus      │ #FFFFFF    │ #D72638   │ #111111  │ #D72638│
│            │            │ +Ring 4px │          │        │
...
║  │ Email Address                                        │   ║
║  │ [________________]  [✓]                              │   ║
║  │ (Border: #E5E7EB, Focus: #D72638 + Ring)            │   ║
║  └──────────────────────────────────────────────────────┘   ║
║                                                              ║
║  ┌──────────────────────────────────────────────────────┐   ║
║  │         [Send Reset Link →]                          │   ║
║  │      (Primary #D72638, Full Width)                   │   ║
...
║  ┌──────────────────────────────────────────────────────┐   ║
║  │         [Reset Password →]                           │   ║
║  │      (Primary #D72638, Disabled until valid)         │   ║
║  └──────────────────────────────────────────────────────┘   ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
```
...
║  │  5  │ │  4  │ │  7  │   │  _  │ │  _  │ │  _  │        ║
║  └─────┘ └─────┘ └─────┘   └─────┘ └─────┘ └─────┘        ║
║  (Large inputs, auto-focus next, #D72638 border on focus)   ║
║                                                              ║
...
║  │ Summer vibes 🌞                │      │      │      │   ║
║  └────────────────────────────────┴──────┴──────┴──────┘   ║
║  (Actions slide in from right, #D72638 background)          ║
║                                                              ║
...
║  │      2m ago  •  [1]                                    │ ║
║  │ (Unread badge - #EF4444, preview text - #7A7A7A)      │ ║
║  └────────────────────────────────────────────────────────┘ ║
║                                                              ║
║  ┌────────────────────────────────────────────────────────┐ ║
║  │ [👤] @styleguru                            ⚪ 5h ago   │ ║
...
║                                                              ║
║  ●○○○○ Progress                                              ║
║  (Progress dots - Active: #D72638, Inactive: #E5E7EB)       ║
║                                                              ║
...
║  ┌──────────────────────────────────────────────────────┐   ║
║  │              [Continue →]                            │   ║
║  │      (Primary #D72638, enabled when ≥1 selected)     │   ║
║  └──────────────────────────────────────────────────────┘   ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
```
...
║  Default:                                                    ║
║  ┌──────────────┐                                            ║
║  │  Click Me!   │  #D72638 bg, #FFFFFF text                 ║
║  └──────────────┘  Shadow: Level 1                          ║
║                                                              ║
║  Hover:                                                      ║
║  ┌──────────────┐                                            ║
...
║  │  Summer Vibes 🌞 │  Border: 2px #D72638                  ║
║  │  $89-$145        │  Duration: 300ms                       ║
║  │  ❤️ 💾 ↗         │  Icons: #D72638 (colorize)            ║
...
║                                                              ║
║  ┌─────────────────────┐                                    ║
║  ║  [Button Text]      ║  ← 3px #D72638 outline            ║
║  └─────────────────────┘     4px offset                     ║
...
║  │    (Line chart - #D72638, gradient fill)              │ ║
║  └────────────────────────────────────────────────────────┘ ║
║                                                              ║
║  Engagement Metrics                                          ║
║  ┌──────────────────┐  ┌──────────────────┐               ║
